...
This document describes the Git workflow for contributing to the <!-- repo name --> project.
...
1. Go to https://github.com/Synobotix/engineering_template
...
Fork
```bash
git remote add upstream https://github.com/Synobotix/engineering_template.git
```
...
upstream  https://github.com/Synobotix/engineering_template.git (fetch)upstream  https://github.com/Synobotix/engineering_template.git (push)
```
...
3. **Important**: Ensure the base repository is `Synobotix/engineering_template` and the base branch is `develop`
...
3. **Set base repository to**: `Synobotix/engineering_template`
