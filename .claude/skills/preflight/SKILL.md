...
- `.claude/_constitution.md` exists as human-readable mirror

If `.opencode/_constitution.md` is missing:

`BLOCKED`

If `.claude/_constitution.md` is missing:

`BLOCKED`  
Fix:

- generate `.claude/_constitution.md` from `.opencode/_constitution.md`
...
| `.claude/_constitution.md` missing | generate mirror from `.opencode/_constitution.md` |
...
- `.claude/_constitution.md` present: `yes/no`
...
- .claude/_constitution.md present
...
- Verify `.claude/_constitution.md` exists as required readable mirror.
