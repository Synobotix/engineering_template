...
This guide will help you set up your local development environment for the <!-- repo name --> project.
...
```bash
git clone https://github.com/Synobotix/engineering_template.git
cd <!-- repo name -->
```
